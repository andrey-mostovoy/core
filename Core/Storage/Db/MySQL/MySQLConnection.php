<?php
namespace stalk\Core\Storage\Db\MySQL;
...
use stalk\Core\Storage\Db\Exception\DatabaseNotFoundException;
use stalk\Core\Storage\Db\Exception\DuplicateEntryException;
use stalk\Core\Storage\Db\Exception\TableNotFoundException;
